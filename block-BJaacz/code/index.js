...
function addThreeToArray(arr){
  let addThreeToArray = [];
  for(let num of arr) {
    addThreeToArray.push(addThree(num));
  }
  return addThreeToArray;
}
/*
...
function addFiveToArray(arr){
  let addFiveToArray = [];
  for(let num of arr) {
    addFiveToArray.push(addFive(num));
  }
  return addFiveToArray;
}
/*
...
*/
function isAdult(personalDetails){
  return personalDetails.age > 18; 
}
/*
...
*/
function isMale(personSex){
  return personSex.sex === `M`;
}
...
*/
function isFemale(personSex){
  return personSex.sex === `F`;
}
/*
...
*/
function isGradeA (personGrade){
  return personGrade.grade > 12;
}
/*
...
*/
function isGradeB (personGrade){
  return personGrade.grade > 8;
}
/*
...
function filterFemale (arr) {
  ...
  for(let person of arr) {
    if(isFemale(person)) {
      finalIsFemale.push(person);
    }
  }
  return finalIsFemale;
}
/*
